...
Image_Nuclei=input_args.NucIntensityImage.Value;
...
objects_intensities_nuclei=accumarray(objects_lbl(objects_idx),Image_Nuclei(objects_idx));
...
output_args.NucleiIntensity=objects_intensities_nuclei;
