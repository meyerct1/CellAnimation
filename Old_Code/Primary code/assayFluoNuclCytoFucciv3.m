...
ImageFolder='~/Dropbox/Stain Images for Analysis/20121109_skmel5/0hr/';
Path='~/Dropbox/Stephen and Darren Shared/20121109 skmel5 data/0 hr/';
Channel_One   =[ImageFolder '20121207170412-3243-R02-C02.tiff']; % Image folder is directory dependent
Channel_Two   =[ImageFolder '20121207170412-3244-R02-C02.tiff'];
Channel_Three=[ImageFolder  '20121207170412-3245-R02-C02.tiff'];
Frame='2';
Well='B02';
