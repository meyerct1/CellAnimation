...
file_base_end=input_args.FileBaseEnd.Value;
cur_frame=input_args.CurFrame.Value;
number_fmt=input_args.NumberFmt.Value;
file_ext=input_args.FileExt.Value;
output_args.FileNameOne=[file_base num2str(cur_frame,number_fmt) file_ext];

output_args.FileNameTwo=[file_base num2str(cur_frame+1,number_fmt) file_ext];

output_args.FileNameThree=[file_base num2str(cur_frame+2,number_fmt) file_ext];
