...
Channel_One   =[ImageFolder '20121207171723-4050-R03-C11.tiff']; % Image folder is directory dependent
Channel_Two =[ImageFolder   '20121207171723-4051-R03-C11.tiff'];
Channel_Three=[ImageFolder  '20121207171723-4052-R03-C11.tiff'];
Frame='1';
Well='C11';
