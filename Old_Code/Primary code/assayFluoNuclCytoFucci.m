...
% script variables
ImageFolder='~/Dropbox/Stain Images for Analysis/A647Staining-12-17-12-BP-p70-p90-A375/1/';
NucleiImage=[ImageFolder '20121217104005-4860-R04-C02.tiff']; % Image folder is directory dependent
CytoImage=[ImageFolder '20121217104005-4861-R04-C02.tiff'];
FucciImage=[ImageFolder '20121217104005-4862-R04-C02.tiff'];
